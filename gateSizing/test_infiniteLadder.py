...
def main(numberOfGates=10, numberOfUnaries=20, numberOfBins=20, interval=(-8, 35), precise=False):
    ...
    delays, newConstr = SSTA.calculateCircuitDelay(startingNodes, cvxpy=True, unary=True, precise=precise)
